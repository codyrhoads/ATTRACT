...
private:
    std::shared_ptr<GameObject> createObject(bool magnetic, bool deadly, bool spawnPoint, bool collectable, bool light, bool moving, bool door, int shape);
    std::shared_ptr<GameObject> createObject(glm::vec3 position, glm::vec3 scale, glm::vec3 rotation, bool magnetic, bool deadly, bool spawnPoint, bool collectable, bool light, bool moving, bool door, int shape);
